...
public class OutListXlsView extends AbstractXlsDownload {
	@Override
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		Map<String, Object> data = (Map<String, Object>) model.get("data");
		String date = (String)data.get("date");
		response.setHeader("Content-Disposition", "attachment; filename=\"outtime_"	+ date + ".xls" + "\"");

		Cell cell = null;

		HSSFSheet sheet1 = (HSSFSheet) workbook.createSheet("퇴근");
		
		sheet1.setDefaultColumnWidth(15);
		
		String[] sheet1Header = {"사번", "퇴근시간"};
		
		String[] sheet1Body = {"L_UID", "OUT_TIME"};
